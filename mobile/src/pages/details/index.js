...
export default function Detail(){
    ...
    const message = `Olá ${incident.nome}, \n\nEstou entrando em contato para ajudar no caso ${incident.titulo}, com o valor de ${Intl.NumberFormat('pt-BR',  {style: 'currency', currency: 'BRL'}).format(incident.valor)}.`;
        ...
        <View style={styles.container}>
            ...
            <View style={styles.incident}>
                ...
                <Text style={styles.incidentValue}>{Intl.NumberFormat('pt-BR', 
                    {style: 'currency', 
                    currency: 'BRL'}).format(incident.valor)}
                </Text>
            </View>
